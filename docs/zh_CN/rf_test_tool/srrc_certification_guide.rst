...
SRRC 认证需准备的硬件有三种，分别是待测样机、串口板和 USB 线，硬件说明如表 1-1 所示。
...
- 对于单载波测试，需要在 Test Mode 选项选择 TX Tone，测试界面见图 7。

.. figure:: ../../_static/rf_test_tool/single_wave_test_interface.jpg
    :align: center
    :scale: 120%
