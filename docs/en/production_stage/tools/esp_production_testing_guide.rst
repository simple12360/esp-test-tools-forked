...
.. only:: esp8266
    ...
    .. list-table::
        ...
        * - V33, GND, RXD, TXD, EN, GPIO0, GPIO15
          - GPIO0 and GPIO15 connected to low level
...
.. only:: esp32c2 or esp32c3 or esp32c6
    ...
    .. list-table::
        ...
        * - V33, GND, RXD, TXD, EN, GPIO8, GPIO9
          - GPIO8 connected to high level and GPIO9 connected to low level
...
.. note::
    ...
    .. list::
        ...
        :esp32c2 or esp32c3 or esp32c6: - The above table is also applicable to ESP8684/ESP8585.
...
.. list-table:: The Primary Structure of a Typical Test Fixture
    ...
    * - Part
      - Description
    * - Handle
      - When users lift the handle, the module is separated from the metal probes at the bottom and gets disconnected from the power supply. When users press the handle, the module comes into contact with the metal probes and starts the testing procedure.
    * - Mounting Panel
...
.. note::
    ...
    .. list::
        ...
        :esp32 or esp32s2 or esp32s3 or esp32c2 or esp32c3 or esp32c6: - The above table is also applicable to ESP8684/ESP8585.
...
.. list::
    ...
    2. Open the production testing software tool and complete the corresponding configuration based on which product series your DUT belongs to. For details, please refer to Section `Tool Configuration`_ below.

    :esp8266: 3. Click ``START`` button to start the test. During the testing, Parameter ``fb_rssi`` in the Log must be kept at around 50.

    :not esp8266: 3. Click ``START`` button to start the test. During the testing, Parameter ``fb_rssi`` in the Log must be kept at around -50.
